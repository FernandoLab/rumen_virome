...
# Beta Diversity - Ion Torrent Total Metagenomes
...
cat cd_hit_454_output_total/*.comb.keep.txt > cd_hit_454_output_total/BMG.cat.comb.keep.txt
 	
awk '{print $1,$2/631225,$3/2261004,$4/1591514,$5/972805,$6/2475541,$7/734576,$8/2011286,$9/509528,$10/1240812,$11/995310,$12/931099,$13/888555,$14/1331228,$15/2070496,$16/3165966,$17/666970,$18/2344185,$19/484852,$20/884957,$21/667046}' cd_hit_454_output_total/BMG.cat.comb.keep.txt > cd_hit_454_output_total/BMG.cat.comb.keep.norm.txt
 	
printf "ID BMG.10 BMG.11 BMG.12 BMG.13 BMG.14 BMG.15 BMG.16 BMG.17 BMG.18 BMG.19 BMG.1 BMG.20 BMG.2 BMG.3 BMG.4 BMG.5 BMG.6 BMG.7 BMG.8 BMG.9\n" > cd_hit_454_output_total/BMG.read_table.txt
	
cat cd_hit_454_output_total/BMG.cat.comb.keep.norm.txt >> cd_hit_454_output_total/BMG.read_table.txt
	
tr ' ' \\t < cd_hit_454_output_total/BMG.read_table.txt > cd_hit_454_output_total/BMG.read_table.tab.txt
	
biom convert -i cd_hit_454_output_total/BMG.read_table.tab.txt -o cd_hit_454_output_total/BMG.read_table.tab.biom --table-type="OTU table" --to-json
```
...
```{r, engine='bash', results='hide'}
beta_diversity.py -i cd_hit_454_output_total/BMG.read_table.tab.biom -o cd_hit_454_output_total/BMG.read_table_bc -m bray_curtis

nmds.py -i cd_hit_454_output_total/BMG.read_table_bc/bray_curtis_BMG.read_table.tab.txt -o cd_hit_454_output_total/BMG.read_table_bc_nmds.txt
```

```{r}
library(ggplot2)
library(vegan)
total_bc <- read.table("cd_hit_454_output_total/BMG.read_table_bc/bray_curtis_BMG.read_table.tab.txt", header=TRUE, row.names=1)
...
total_nmds <- read.table("cd_hit_454_output_total/BMG.read_table_bc_nmds.txt", nrow = 20, sep = "\t", header=TRUE)
...
tiff("figures/total_reads_nmds.tiff", height = 6, width = 12, units='in', res=300)
...
total_tab <- fread("cd_hit_454_output_total/BMG.read_table.tab.txt", header=TRUE, sep="\t")
...
biplot_df2 <- data.frame(text_x = as.numeric(c("0.98", "-0.9", "0.56")), biplot_df)
biplot_df3 <- data.frame(text_y = as.numeric(c("-0.12", "-0.55", "0.068")), biplot_df2)
...
```{r, engine='bash'}
printf "\n27CDS 55CS 55CS 27CDS Control 40MDGS 27CDS 27CDS 55CS 40MDGS Control Control Control 40MDGS 27CDS 55CS 40MDGS 40MDGS Control 55CS" >> cd_hit_454_output_total/config.txt
printf "\n259 346 3244 222 3257 259 346 3244 222 3257 346 259 3244 222 3257 259 346 3244 222 3257" >> cd_hit_454_output_total/config.txt
	
perl scripts/get_pairwise_dist_diet.pl -diet1=27CDS -diet2=55CS -distance=cd_hit_454_output_total/BMG.read_table_bc/bray_curtis_BMG.read_table.tab.txt -config=cd_hit_454_output_total/config.txt

perl scripts/get_pairwise_dist_diet.pl -diet1=27CDS -diet2=Corn -distance=cd_hit_454_output_total/BMG.read_table_bc/bray_curtis_BMG.read_table.tab.txt -config=cd_hit_454_output_total/config.txt

perl scripts/get_pairwise_dist_diet.pl -diet1=27CDS -diet2=40MDGS -distance=cd_hit_454_output_total/BMG.read_table_bc/bray_curtis_BMG.read_table.tab.txt -config=cd_hit_454_output_total/config.txt

perl scripts/get_pairwise_dist_diet.pl -diet1=55CS -diet2=Corn -distance=cd_hit_454_output_total/BMG.read_table_bc/bray_curtis_BMG.read_table.tab.txt -config=cd_hit_454_output_total/config.txt

perl scripts/get_pairwise_dist_diet.pl -diet1=55CS -diet2=40MDGS -distance=cd_hit_454_output_total/BMG.read_table_bc/bray_curtis_BMG.read_table.tab.txt -config=cd_hit_454_output_total/config.txt

perl scripts/get_pairwise_dist_diet.pl -diet1=Corn -diet2=40MDGS -distance=cd_hit_454_output_total/BMG.read_table_bc/bray_curtis_BMG.read_table.tab.txt -config=cd_hit_454_output_total/config.txt
```
