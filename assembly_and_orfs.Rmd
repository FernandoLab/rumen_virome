...
```{r, engine='bash', results='hide'}
prinseq-lite.pl -fasta vmg.orfs_nt.fasta -min_len 300 -out_format 1 -out_good vmg.orfs_nt.filter
...
Assembly the microbial metagenome data using Spades.
...
```{r, engine='bash', results='hide'}
prinseq-lite.pl -fasta bmg.orfs_nt.fasta -min_len 300 -out_format 1 -out_good bmg.orfs_nt.filter
...
```{r, engine='bash', results='hide'}
prinseq-lite.pl -fasta vmg.illumina.orfs_nt.fasta -min_len 300 -out_format 1 -out_good vmg.illumina.orfs_nt.filter
