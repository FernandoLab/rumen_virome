...
```{r, engine='bash'}
perl scripts/khmer_multi_threshold.pl -khmer_multi_dir=viral_qc -threshold=1

mv *.comb.keep.txt viral_qc/

python scripts/circos_make_table.py -d viral_qc/ -c viral_qc/config_sub.txt -i T -s subsample.fna.comb.keep.txt > viral_circos_list_sub.txt
```

```{r, cache=FALSE}
options(stringsAsFactors=FALSE)
matrix_out <- data.frame(matrix(NA, nrow = 15, ncol = 15))
pw <- read.table("viral_circos_list_sub.txt", sep="\t", header=FALSE)
...
write.table(matrix_out, file="viral_circos_table_sub.txt", sep="\t", row.names=TRUE, col.names=NA, quote=FALSE)
```

```{r, engine='bash'}
sed -E $'s/\tCorn-3257/labels\tCorn-3257/g' viral_circos_table_sub.txt > viral_circos_table2_sub.txt

printf "labels\n255,211,0\n0,159,107\n255,211,0\n196,2,51\n196,2,51\n196,2,51\n255,211,0\n0,159,107\n196,2,51\n0,159,107\n0,135,189\n0,159,107\n0,135,189\n255,211,0\n0,135,189" > viral_circos_row_colors.txt

paste viral_circos_row_colors.txt viral_circos_table2_sub.txt > circos_viral_all_samples_upload.txt

printf "labels\n211,211,211\n211,211,211\n211,211,211\n211,211,211\n211,211,211\n211,211,211\n211,211,211\n211,211,211\n211,211,211\n211,211,211\n0,135,189\n211,211,211\n0,135,189\n211,211,211\n0,135,189" > circos_row_colors_27cds.txt
paste circos_row_colors_27cds.txt viral_circos_table2_sub.txt > circos_viral_27cds_upload.txt

printf "labels\n211,211,211\n211,211,211\n211,211,211\n196,2,51\n196,2,51\n196,2,51\n211,211,211\n211,211,211\n196,2,51\n211,211,211\n211,211,211\n211,211,211\n211,211,211\n211,211,211\n211,211,211" > circos_row_colors_55cs.txt
paste circos_row_colors_55cs.txt viral_circos_table2_sub.txt > circos_viral_55cs_upload.txt

printf "labels\n211,211,211\n0,159,107\n211,211,211\n211,211,211\n211,211,211\n211,211,211\n211,211,211\n0,159,107\n211,211,211\n0,159,107\n211,211,211\n0,159,107\n211,211,211\n211,211,211\n211,211,211" > circos_row_colors_40mdgs.txt
paste circos_row_colors_40mdgs.txt viral_circos_table2_sub.txt > circos_viral_40mdgs_upload.txt

printf "labels\n255,211,0\n211,211,211\n255,211,0\n211,211,211\n211,211,211\n211,211,211\n255,211,0\n211,211,211\n211,211,211\n211,211,211\n211,211,211\n211,211,211\n211,211,211\n255,211,0\n211,211,211\n" > circos_row_colors_corn.txt
paste circos_row_colors_corn.txt viral_circos_table2_sub.txt > circos_viral_corn_upload.txt
```
...
python scripts/circos_make_table.py -d viral_qc/ -c viral_qc/config_cat_sub.txt -i F -s sub_cat.fna.comb.keep.txt > circos_list_sub_cat.txt

mkdir viral_qc/sub_diet_comb
mv viral_qc/*sub_cat.fna.comb.keep.txt viral_qc/sub_diet_comb
mv viral_qc/*sub_cat.fna.comb viral_qc/sub_diet_comb
```
...
- circos_viral_all_samples_upload.txt
- circos_viral_diets_upload.txt
