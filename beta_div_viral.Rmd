...
tiff("figures/figure_s2b_nolabel.tiff", height = 6, width = 12, units='in', res=600)
...
```{r, engine='bash'}
printf "\n27CDS 55CS 55CS 27CDS Corn 40MDGS Corn Corn 40MDGS 27CDS 55CS 40MDGS 40MDGS Corn 55CS" >> viral_beta_div/config.txt
printf "\n259 346 3244 222 3257 259 346 3244 222 3257 259 346 3244 222 3257" >> viral_beta_div/config.txt

perl scripts/get_pairwise_dist_diet.pl -diet1=27CDS -diet2=55CS -distance=viral_beta_div/VMG.read_table_bc/bray_curtis_VMG.read_table.tab.txt -config=viral_beta_div/config.txt

perl scripts/get_pairwise_dist_diet.pl -diet1=27CDS -diet2=Corn -distance=viral_beta_div/VMG.read_table_bc/bray_curtis_VMG.read_table.tab.txt -config=viral_beta_div/config.txt

perl scripts/get_pairwise_dist_diet.pl -diet1=27CDS -diet2=40MDGS -distance=viral_beta_div/VMG.read_table_bc/bray_curtis_VMG.read_table.tab.txt -config=viral_beta_div/config.txt

perl scripts/get_pairwise_dist_diet.pl -diet1=55CS -diet2=Corn -distance=viral_beta_div/VMG.read_table_bc/bray_curtis_VMG.read_table.tab.txt -config=viral_beta_div/config.txt

perl scripts/get_pairwise_dist_diet.pl -diet1=55CS -diet2=40MDGS -distance=viral_beta_div/VMG.read_table_bc/bray_curtis_VMG.read_table.tab.txt -config=viral_beta_div/config.txt

perl scripts/get_pairwise_dist_diet.pl -diet1=Corn -diet2=40MDGS -distance=viral_beta_div/VMG.read_table_bc/bray_curtis_VMG.read_table.tab.txt -config=viral_beta_div/config.txt
```
