...
python ../get_comb_multi_old_median_kmer.py config_cat_sub.txt
...
```{r, engine='bash'}
mkdir prinseq_output/sub_sample_comb
mv prinseq_output/*.comb.keep.txt prinseq_output/sub_sample_comb
...
mv prinseq_output/*.comb.keep.txt prinseq_output/sub_diet_comb
```
...
```{r, engine='bash'}
sed -E $'s/\tCorn/labels\tCorn/g' circos_table_sub_cat.txt > circos_table_sub_cat2.txt

printf "labels\n255,211,0\n0,159,107\n196,2,51\n0,135,189" > circos_row_colors_cat.txt
